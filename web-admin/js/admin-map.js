...
const VAL_CENTER = [14.7136, 120.9752];
const VAL_BOUNDS_LATLNG = [
    [14.6686, 120.9256],
    [14.7585, 121.0247],
];
...
const VAL_BOUNDARY_LATLNG = [
    ...
    [14.6791702, 120.968574],
    [14.6749959, 120.9648511],
    [14.6825185, 120.9644397],
    [14.6864835, 120.961018],
    [14.696211, 120.9561885],
    [14.6942028, 120.9524492],
    [14.7217088, 120.930927],
...
function centerMapToCity() {
    ...
    mapInstance.flyToBounds(L.latLngBounds(VAL_BOUNDS_LATLNG), {
        duration: 0.8,
        padding: [50, 50],
    });
}
