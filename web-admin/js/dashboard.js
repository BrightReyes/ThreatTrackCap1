...
document
    .getElementById("card-open-incidents")
    ?.addEventListener("click", () => {
        window.location.href = "incidents.html?filter=open";
    });

document.getElementById("card-reports-24h")?.addEventListener("click", () => {
    window.location.href = "incidents.html?filter=24h";
});
...
document
    .getElementById("card-total-incidents")
    ?.addEventListener("click", () => {
